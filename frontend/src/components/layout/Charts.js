      ...
      <div>
          <div className="container-fluid">
              ...
              <p className="mb-4">Chart.js is a third party plugin that is used to generate the charts in this theme.
                  The charts below have been customized - htmlFor further customization options, please visit the <a
                  ...
                  <div className="col-xl-8 col-lg-7">
                      ...
                      <div className="card shadow mb-4">
                          ...
                          <div className="card-body">
                              ...
                              <hr/>
                                  Styling htmlFor the area chart can be found in the
                      ...
                      <div className="card shadow mb-4">
                          ...
                          <div className="card-body">
                              ...
                              <hr/>
                                  Styling htmlFor the bar chart can be found in the
                  ...
                  <div className="col-xl-4 col-lg-5">
                      <div className="card shadow mb-4">
                          ...
                          <div className="card-body">
                              ...
                              <hr/>
                                  Styling htmlFor the donut chart can be found in the
